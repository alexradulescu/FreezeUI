/**
 * ES5 version.
 * This should work IE11+ and all other major browsers.
 */
(function() {
    'use strict';
    ...
    var styleDom = document.createElement('style');
        styleDom.innerHTML = '@keyframes load {' + 
                + '0% { transform:translate3d(-50%, -50%, 0) rotate(0deg); }' +
                + '100% { transform:translate3d(-50%, -50%, 0) rotate(360deg); }' +
            + '}' +
            + '.freeze-ui { position:fixed; top:0; left:0; width:100%; height:100%; z-index:999999999; background-color:rgba(255, 255, 255, .8); }' +
